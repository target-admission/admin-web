			...
			<Spin spinning={isLoading}>
				<div className="grid lg:grid-cols-4 grid-cols-2 gap-4 mb-6">
					<Card
						...
						bordered={false}
					>
						<h1 className="font-semibold text-text-light">Total Subjects</h1>
					...
					<Card
						...
						bordered={false}
					>
						<h1 className="font-semibold text-text-light">New Subjects</h1>
					...
					<Card
						...
						bordered={false}
					>
						<h1 className="font-semibold text-text-light">Deleted Subjects</h1>
